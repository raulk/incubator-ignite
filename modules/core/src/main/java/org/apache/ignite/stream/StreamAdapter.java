...
public abstract class StreamAdapter<T, K, V> {
    ...
    private SingleStreamTupleExtractor<T, K, V> singleTupleExtractor;
     ...
     */
    protected StreamAdapter(IgniteDataStreamer<K, V> stmr, SingleStreamTupleExtractor<T, K, V> extractor) {
        this.stmr = stmr;
     ...
     * @see #setSingleTupleExtractor(SingleStreamTupleExtractor)
     */
    @Deprecated
     ...
     */
    public SingleStreamTupleExtractor<T, K, V> getSingleTupleExtractor() {
     ...
     */
    public void setSingleTupleExtractor(SingleStreamTupleExtractor<T, K, V> singleTupleExtractor) {
        if (multipleTupleExtractor != null) {
            throw new IllegalArgumentException("Multiple tuple extractor already set; cannot set both types at once.");
        }
